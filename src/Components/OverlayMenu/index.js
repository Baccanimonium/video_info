...
// TODO удалить переменную axis по всему приложению, у нас окна теперь открываются только сверху или снизу

// todo в новом брифе подсказки не встают под иконкой
